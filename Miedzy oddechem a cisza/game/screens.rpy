...
##
## Ten ekran musi utworzyć dane wejściowe wyświetlane z identyfikatorem
## "input", aby zaakceptować różne parametry wejściowe.
##
...
##
## Nie ma nic specjalnego w tym ekranie, dlatego służy on również jako
## przykład, jak zrobić niestandardowy ekran.
...
## Ekran powiadomień ###########################################################
##
## Ekran powiadomień służy do pokazywania graczowi wiadomości. (Na przykład,
## gdy gra została szybko zapisana lub zrobiono zrzut ekranu).
##
...
## Bubble screen ###############################################################
##
## Ekran bąbelkowy jest używany do wyświetlania graczowi dialogu, gdy używa
## się bąbelków mowy. Ekran bąbelkowy przyjmuje te same parametry co ekran say,
