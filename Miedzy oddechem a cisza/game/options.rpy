...
define config.name = _("Miedzy oddechem a cisza")
...
define build.name = "Miedzyoddechemacisza"
...
## Zarządzanie oknem ###########################################################
##
## Opcja odpowiada za okno dialogowe. Jeżeli ustawiono "show" (pokaż), to
## będzie zawsze wyświetlone. Jeżeli ustawiono "hide" (ukryj), to zostanie
## wyświetlone kiedy będzie dialog. Jeżeli ustawiono "auto" to okno jest
## ukrywane przed wypowiedziami scen i ponownie wyświetlane po wyświetleniu
## dialogu.
##
...
define config.save_directory = "Miedzyoddechemacisza-1755010698"
...
init python:
    ...
    ## podkatalogów, a "**.psd" dopasowuje pliki psd w dowolnym miejscu projektu.
