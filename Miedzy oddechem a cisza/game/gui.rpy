...
##
## Przycisk na pliki zapisu (slot) jest specjalnym rodzejem przycisku.
## Zawiera obraz miniatury oraz tekst opisujący zawartość slotu zapisu. Slot
## zapisu wykorzystuje pliki graficzne w gui/button, podobnie jak inne rodzaje
## przycisków.
...
## Odstępy między wpisami trybu NVL, gdy gui.nvl_height ma wartość
## "None" (brak) oraz między wpisami trybu NVL a menu trybu NVL.
...
## Kontroluje to, gdzie dozwolone jest łamanie wiersza. Ustawienie
## domyślne jest odpowiednie dla większości języków. Listę dostępnych
## wartości można znaleźć pod adresem https://www.renpy.org/doc/html/
## style_properties.html#style-property-language
